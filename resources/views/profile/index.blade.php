...
@section('title', 'Creator Profiles - ' . config('app.name', 'Laravel'))
@section('meta_description', 'Browse our top creators and their impressive portfolios of successful digital products.')
...
@section('content')
    <div class="min-h-screen relative overflow-hidden">
        ...
        <div class="container max-w-7xl mx-auto px-4 py-12 relative z-10 animate-[fadeIn_0.5s_ease-in]">
                ...
                @foreach($creators as $creator)
                    <div class="feature-card bg-white/80 dark:bg-gray-800/80 blur-card rounded-2xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 group">
                        <div class="p-8 flex flex-col items-center text-center">
                            ...
                            <!-- Creator Info -->
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">{{ $creator->name }}</h2>
                            <p class="text-gray-600 dark:text-gray-400 mb-4">{{ $creator->specialty }}</p>
                            
                            <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full mb-6"></div>
                            
                            <div class="flex items-center justify-center mb-6">
                                <div class="px-4 border-r border-gray-300 dark:border-gray-700">
                                    <div class="text-xl font-bold text-gray-900 dark:text-white">{{ $creator->products_count }}</div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400">Products</div>
                                </div>
                                <div class="px-4">
                                    <div class="text-xl font-bold text-gray-900 dark:text-white">${{ number_format($creator->total_mrr, 0) }}</div>
                            ...
                            <div class="flex items-center justify-center space-x-3 mb-6">
                                @if($creator->twitter)
                                    <a href="{{ $creator->twitter }}" target="_blank" class="social-icon w-9 h-9 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center text-blue-500 hover:bg-blue-500 hover:text-white transition-colors">
                                ...
                                @endif
                                @if($creator->github)
                                    <a href="{{ $creator->github }}" target="_blank" class="social-icon w-9 h-9 rounded-full bg-gray-50 dark:bg-gray-800 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:bg-gray-700 hover:text-white dark:hover:bg-gray-600 transition-colors">
                                ...
                                @endif
                                @if($creator->website)
                                    <a href="{{ $creator->website }}" target="_blank" class="social-icon w-9 h-9 rounded-full bg-purple-50 dark:bg-purple-900/20 flex items-center justify-center text-purple-500 hover:bg-purple-500 hover:text-white transition-colors">
                            ...
                            <!-- View Profile Button -->
                            <a href="{{ route('creator.profile', $creator) }}" class="btn-primary w-full py-3 px-4 text-white font-medium text-center rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
                                View Profile
                            </a>
                        </div>
                    </div>
            ...
            <!-- CTA Section -->
            <div class="mb-20 relative mt-24">
                <div class="blur-card bg-gradient-to-r from-blue-500/80 to-indigo-600/80 rounded-2xl p-10 text-white shadow-xl relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <div class="max-w-3xl mx-auto text-center">
                            <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Join Our Creator Community</h2>
                            <p class="text-lg text-white/80 mb-8">
                                Are you building impressive digital products? Apply to join our exclusive community of creators and showcase your work.
                            </p>
                            <a href="/register" class="inline-block py-3 px-8 bg-white hover:bg-gray-100 text-blue-600 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 pulse-animation">
                                Apply Now
                            </a>
                        </div>
                    </div>
